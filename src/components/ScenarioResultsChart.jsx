...
const ScenarioResultsChart = ({ scenario }) => (
  <div className="mt-4 w-full border rounded-lg p-4 mb-4 bg-white shadow">
    <div className="mb-2">
      ...
      <div>
        <div className="mb-2">
          <span className="font-semibold text-md">Scenario: {scenario.scenario}</span>
        </div>
        {scenario.formula && (
          <div>
            <hr></hr>
        ...
        <div className="mt-4 mb-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {scenario.variables && scenario.variables.map((v, i) => (
              ...
              >
                <div className="font-mono font-semibold mb-1">{v.name}</div>
                <div className="text-xs mb-2 text-gray-700">Distribution: {v.distribution}</div>
